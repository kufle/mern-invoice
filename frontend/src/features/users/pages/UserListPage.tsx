...
import { useDeactivateUserMutation, useDeleteUserMutation, useGetAllUsersQuery } from '../userApiSlice';
...
function UserListPage() {
  ...
  const { data, isLoading, isSuccess, isError, error }: any = useGetAllUsersQuery(
		"allUsersList",
		{
