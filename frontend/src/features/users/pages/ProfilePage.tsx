...
import { useDeleteMyAccountMutation, useGetUserProfileQuery } from '../userApiSlice';
import { Avatar, Box, Button, Container, CssBaseline, Grid, List, ListItem, ListItemIcon, ListItemText, Modal, Stack, Typography } from '@mui/material';
...
function ProfilePage() {
  const navigate = useNavigate();
	const { data, error, isLoading, isError }: any = useGetUserProfileQuery();
