import { Box, Button, CircularProgress, Container, CssBaseline, Grid, styled, TextField, Typography } from '@mui/material'
import { useEffect, useState } from 'react'
import StyledDivider from '../../../components/StyledDivider';
import BrowserUpdatedIcon from "@mui/icons-material/BrowserUpdated";
import CheckIcon from "@mui/icons-material/Check";
import PhotoCamera from "@mui/icons-material/PhotoCamera";
import { useGetUserProfileQuery, useUpdateUserProfileMutation } from '../userApiSlice';
...
function EditProfileForm() {
  ...
  const [updateMyProfile, { data: updateData, isLoading, isSuccess }] = useUpdateUserProfileMutation();
